...
var _chapters=[
  {t:0, title:'Welcome & Overview',
   ...
   bullets:['End-to-end SQL Server to Databricks migration','11+ integrated modules in a single UI','AI-powered conversion and self-healing','Zero-downtime production deployment']},
  ...
  {t:90, title:'Convert to PySpark',
   voice:'The Convert to PySpark module is the heart of the accelerator. With one click, it uses AI to convert your SQL stored procedures, views, and UDFs into clean, production-ready PySpark notebooks. Each converted object gets its own Databricks notebook, complete with proper Spark SQL syntax and helper functions.',
   bg:'linear-gradient(135deg,#DC2626,#F97316)',
   icon:'<svg viewBox="0 0 120 120" fill="none"><rect x="15" y="12" width="50" height="40" rx="6" stroke="#FCA5A5" stroke-width="2"/><text x="40" y="38" text-anchor="middle" fill="#FCA5A5" font-size="11" font-weight="600">T-SQL</text><rect x="55" y="65" width="50" height="40" rx="6" stroke="#86EFAC" stroke-width="2"/><text x="80" y="91" text-anchor="middle" fill="#86EFAC" font-size="11" font-weight="600">PySpark</text><path d="M50 52 L70 65" stroke="#FBBF24" stroke-width="2.5"><animate attributeName="stroke-dasharray" values="0 40;40 0" dur="1.5s" repeatCount="indefinite"/></path><circle cx="60" cy="58" r="10" fill="#FBBF24" opacity=".9"/><text x="60" y="62" text-anchor="middle" fill="#fff" font-size="10" font-weight="bold">AI</text></svg>',
   bullets:['AI-powered T-SQL to PySpark conversion','One notebook per stored procedure','UDFs bundled into HelperFunction.py','Handles complex JOINs, CTEs, temp tables']},
  ...
  voice:'When errors happen, the System Health Check diagnoses them automatically. Paste any error message or stack trace, and the AI analyzes the root cause, provides a detailed explanation, and suggests specific fixes. It understands Databricks, Spark, and Python exceptions natively.',
   ...
   bullets:['AI-powered error diagnosis','Paste any error or stack trace','Root cause analysis & fix suggestions','Spark, Python, Databricks aware']},
  ...
  {t:280, title:'Data Modeling',
   voice:'The Data Modeling module uses AI to classify your tables into a Star or Snowflake schema automatically. It generates interactive ER diagrams, lets you edit table roles, add or remove columns, and produces ready-to-run DDL statements for your data warehouse.',
   ...
   bullets:['AI-driven Star / Snowflake classification','Interactive ER diagram visualization','Inline table & column editing','Auto-generated DDL statements']},

  {t:310, title:'Summary & Next Steps',
   ...
   bullets:['11 integrated migration modules','AI-powered conversion & healing','Production-ready deployment pipeline','Click any tab to get started!']}
];
var _total=330;
